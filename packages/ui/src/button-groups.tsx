		...
		compoundVariants: [
			{
				variant: "outline",
				intent: "brand",
				className: "border-stroke-brand-strong text-brand hover:bg-fill-hover active:bg-fill-press",
			},
			{
				variant: "outline",
				intent: "neutral",
				className: "border-stroke-weak text-fg hover:bg-fill-hover active:bg-fill-press",
			},
			{
				variant: "outline",
				intent: "error",
				className: "border-stroke-error-strong text-error hover:bg-fill-hover active:bg-fill-press",
			},
			{
				variant: "filled",
				intent: "brand",
				className: "bg-brand text-fg-inverse hover:opacity-90 active:opacity-80",
			},
			{
				variant: "filled",
				intent: "neutral",
				className: "bg-fill text-fg-inverse hover:opacity-90 active:opacity-80",
			},
			{
				variant: "filled",
				intent: "error",
				className: "bg-error text-fg-inverse hover:opacity-90 active:opacity-80",
			},
			{
				variant: "ghost",
				intent: "brand",
				className: "text-brand hover:bg-fill-hover active:bg-fill-press",
			},
			{
				variant: "ghost",
				intent: "neutral",
				className: "text-fg hover:bg-fill-hover active:bg-fill-press",
			},
			{
				variant: "ghost",
				intent: "error",
				className: "text-error hover:bg-fill-hover active:bg-fill-press",
			},
			{
				variant: "link",
				intent: "brand",
